...
if ($pageData['url']=="") {
	...
	$tpl -> assign ( "News", $Article -> GetShortArticles ($filter, 0, 2) );
}
else {
	...
	switch (count($PARAMS)) {
		...
		case 3:
			...
			$tpl -> assign ( "module_articles", $tpl->fetch($cfg['PATH']['admin_modules_path']."news/templates/front-detail.tpl.php") );
			break;	
