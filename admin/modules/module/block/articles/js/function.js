...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$j("#year-list").change(function(){                                           
		...
		if (year > 0){ 				
   			...
   			$j.ajax({
				url: "/admin/modules/module/block/articles/handler/article-get-items.handler.php",
				type: "POST",
				dataType: "json",
				data: ({
					year : year
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$j("#article-list").change(function(){                                           
		...
		if (id_article > 0){
   			...
   			$j.ajax({
				url: "/admin/modules/module/block/articles/handler/article-get-details.handler.php",
				type: "POST",
				dataType: "json",
				data: ({
	...
	$j("#article-button-submit").click(function(){
		...
		if ((id_article!="") && (id_article>0) && (title!="") && (annot!="") && (text!="") && (date!="")) {
			...
			$j.ajax({
				...
				url: "/admin/modules/module/block/articles/handler/article-update.handler.php",
				type: "POST",
				dataType: "json",
				data: ({
					id_article	: id_article,
	...
	$j("#article-button-create").click(function(){
		...
		if ((title!="") && (annot!="") && (text!="") && (date!="")) {
			...
			$j.ajax({
				...
				url: "/admin/modules/module/block/articles/handler/article-create.handler.php",
				type: "POST",
				dataType: "json",
				data: ({
					title	: title,
		...
		if ((id_article != "")&&(id_article > 0)) {
			...
			if (confirm("Вы действительно хотите удалить выбранную статью?")) {
				...
				$j.ajax({
					...
					url: "/admin/modules/module/block/articles/handler/article-delete.handler.php",
					type: "POST",
					dataType: "json",
					data: {
						id_article : id_article
