...
if (isset($_POST['id_album']) && !empty($_POST['id_album']) && is_numeric($_POST['id_album']) &&
	isset($_POST['name']) && !empty($_POST['name']) && isset($_POST['alias']) && isset($_POST['descr'])) {

	print win($Gallery -> UpdateAlbum($_POST['id_album'], utf8($_POST['alias']), utf8($_POST['name']), utf8($_POST['descr'])));
}
else {
	$result = "error";
