...
if ((isset($_POST['pid'])) && (!empty($_POST['pid'])) && (is_numeric($_POST['pid'])) &&
	...
	(isset($_POST['recipe'])) && (isset($_POST['description'])) && (isset($_POST['picture'])) &&
	( (!empty($_POST['recipe']) && !empty($_POST['description']) && !empty($_POST['picture'])) || empty($_POST['recipe'])) ) {
	...
	print win( $Menu -> CreateItem ($_POST['pid'], $_POST['id_cat'], utf8($_POST['name']), utf8($_POST['annot']), utf8($_POST['portion']), $_POST['price'], $_POST['recipe'], utf8($_POST['description']), utf8($_POST['picture'])) );
}
else {
	$result = "error";
