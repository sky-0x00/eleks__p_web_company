...
require_once $_SERVER['DOCUMENT_ROOT'].'/admin/lib/excel/writer/format.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/admin/lib/excel/writer/biffwriter.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/admin/lib/excel/writer/worksheet.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/admin/lib/excel/writer/parser.php';
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    function Spreadsheet_Excel_Writer_Workbook($filename)
    {
        ...
        $this->_tmp_dir         = $_SERVER['DOCUMENT_ROOT'].'/report/';
    }
