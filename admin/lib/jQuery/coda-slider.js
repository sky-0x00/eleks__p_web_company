...
jQuery.fn.codaSlider = function(settings) {
	...
	return this.each(function(){
		...
		container.each(function(i) {
			...
			jQuery(this).after("<input class='leftarrow' type='button' id='stripNavL" + j + "'>");

			//jQuery(this).after("<div class='stripNavR' id='stripNavR" + j + "'><a href='#'>Right</a><\/div>");
			jQuery(this).after(" <input class='rightarrow' type='button'  id='stripNavR" + j + "'>");

			// Left nav
			jQuery("#stripNavL" + j + "").click(function(){
			...
			// Right nav
			jQuery("#stripNavR" + j + "").click(function(){
